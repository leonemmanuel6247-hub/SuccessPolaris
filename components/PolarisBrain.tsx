  ...
  return (
    <div className="fixed bottom-6 right-6 z-[7000] animate-in slide-in-from-bottom-10 duration-1000 flex flex-col items-end">
      <div className="group relative">
        ...
        <div id="affichage-stats-mini" className="relative bg-slate-950/60 backdrop-blur-3xl border border-white/10 px-4 py-2.5 rounded-[1.2rem] shadow-2xl flex items-center gap-3 border-r-cyan-500/50">
           ...
           <div className="flex flex-col">
              ...
              <span className="text-[13px] font-black text-white flex items-baseline gap-1">
                {/* ID ISOLÉ POUR LE SCRIPT DE COMPTAGE */}
                <span id="chiffre-compteur-mini">{count}</span> 
